 ...
 *
 * @property array $mainMenuConfig
 * @property string $bodyLayout
 * @property string $skin
 * @property null|array|string $assetBundleConfig
 * @property string $homeUrl
 * @property array $extraAssets
 * @property string[] $userBody
 * @property string $defaultAssetBundleClass
 * @property string $companyName
 * @property string $shotCompanyName
